...
(function () {
  ...
  Game.prototype.add = function (object) {
    if (object.isAsteroid) {
      this.asteroids.push(object);
        ...
        this.bullets[object.id].push(object);
  ...
  Game.prototype.addBullet(from) {
    ...
    if (!from.reloading && this.credits > 11000) {
      this.game.add(bullet, from);
      if (from.playerShip) {
        this.credits -= 10000;
      }
      from.reloading = true;
  ...
  Game.prototype.allObjects = function () {
    return [].concat(this.asteroids, this.ships, this.mediumAsteroids, this.miniAsteroids, this.bullets, this.woolongs).reverse();
  };

  Game.prototype.allSpawnedObjects = function () {
    return [].concat(this.ships, this.bullets, this.woolongs, this.asteroids, this.mediumAsteroids, this.miniAsteroids);
  };
