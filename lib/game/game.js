...
(function() {
  ...
  Game.prototype.initializePlayerShip = function() {
    var ship = new Asteroids.PlayerShip(
      ...
      window.setTimeout(function() { ship.inPlay() } , 25000);
  };
    ...
    that.allObjects().forEach(function(obj1) {
      that.allObjects().forEach(function(obj2) {
        ...
        if (obj1.isCollidedWith(obj2)) {
          ...
          } else if (obj1.isShip && obj2.areWoolongs) {
            that.addCredits(obj2);
            obj2.toRemove = true;
          } else if (obj1.isBullet && obj2.areWoolongs) {
            obj1.toRemove = true;
            obj2.toRemove = true;
          } else if (obj1.isAsteroid && obj2.areWoolongs) {
            obj2.toRemove = true;
          }
        }
      });
