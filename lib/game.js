(function () {
  ...
  Game.prototype.asteroidDestroyed = function (asteroid) {
    if (asteroid.isMediumAsteroid) {
      minis = [new Asteroids.MiniAsteroids(asteroid, {game: this}),
              new Asteroids.MiniAsteroids(asteroid, {game: this})];
      ...
      mediums = [new Asteroids.MediumAsteroids(asteroid, {game: this}),
                 new Asteroids.MediumAsteroids(asteroid, {game: this})];
