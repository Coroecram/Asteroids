(function () {
  ...
  Game.prototype.asteroidDestroyed = function (asteroid) {
    ...
    this.asteroidWoolongs(asteroid);
  };

  Game.prototype.asteroidWoolongs = function (asteroid) {
    var woolongs = new Asteroids.Woolongs({ game: this, pos: asteroid.pos, invincible: true })
    this.add(woolongs);
