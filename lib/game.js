(function () {
  ...
  Game.prototype.allObjects = function () {
    return [].concat(this.ship, this.asteroids, this.mediumAsteroids, this.miniAsteroids, this.bullets);
  };
  ...
  Game.prototype.reasonablePosition = function () {
    ...
    return Asteroids.Util.distributedPositions(xPositions, yPositions);
  };
  ...
  Game.prototype.asteroidDestroyed = function (asteroid) {
    if (asteroid.isAsteroid) {
      mediums = [new Asteroids.MediumAsteroid(asteroid, {game: this}),
              new Asteroids.MediumAsteroid(asteroid, {game: this})];
      this.mediumAsteroids.push(mediums);
    } else if (asteroid.isMediumAsteroid) {
      minis = [new Asteroids.MiniAsteroid(asteroid, {game: this}),
              new Asteroids.MiniAsteroid(asteroid, {game: this})];
      this.miniAsteroids.push(minis);
    } else {
