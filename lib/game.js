(function () {
  ...
  Game.prototype.asteroidDestroyed = function (asteroid) {
    if (asteroid.isMediumAsteroid) {
      minis = [new Asteroids.MiniAsteroids(asteroid.vel, {game: this}),
              new Asteroids.MiniAsteroids(asteroid.vel, {game: this})];
      ...
      mediums = [new Asteroids.MediumAsteroids(asteroid.vel, {game: this}),
                 new Asteroids.MediumAsteroids(asteroid.vel, {game: this})];
